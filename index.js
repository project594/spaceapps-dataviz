...
var ASM_CONSTS = {
  99704: () => { if (document.fullscreenElement) return 1; },  
 99750: () => { return Module.canvas.width; },  
 99782: () => { return parseInt(Module.canvas.style.width); },  
 99830: () => { document.exitFullscreen(); },  
 99857: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 99930: () => { if (document.fullscreenElement) return 1; },  
 99976: () => { return Module.canvas.width; },  
 100008: () => { return screen.width; },  
 100033: () => { document.exitFullscreen(); },  
 100060: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 100193: () => { return window.innerWidth; },  
 100219: () => { return window.innerHeight; },  
 100246: () => { if (document.fullscreenElement) return 1; },  
 100292: () => { return Module.canvas.width; },  
 100324: () => { return parseInt(Module.canvas.style.width); },  
 100372: () => { if (document.fullscreenElement) return 1; },  
 100418: () => { return Module.canvas.width; },  
 100450: () => { return screen.width; },  
 100475: () => { return window.innerWidth; },  
 100501: () => { return window.innerHeight; },  
 100528: () => { if (document.fullscreenElement) return 1; },  
 100574: () => { return Module.canvas.width; },  
 100606: () => { return screen.width; },  
 100631: () => { document.exitFullscreen(); },  
 100658: () => { if (document.fullscreenElement) return 1; },  
 100704: () => { return Module.canvas.width; },  
 100736: () => { return parseInt(Module.canvas.style.width); },  
 100784: () => { document.exitFullscreen(); },  
 100811: ($0) => { Module.canvas.style.opacity = $0; },  
 100849: () => { return screen.width; },  
 100874: () => { return screen.height; },  
 100900: () => { return window.screenX; },  
 100927: () => { return window.screenY; },  
 100954: () => { return window.devicePixelRatio; },  
 100990: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 101043: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 101094: () => { Module.canvas.style.cursor = 'none'; },  
 101131: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 101387: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 101438: () => { if (document.pointerLockElement) return 1; },  
 101485: () => { if (document.fullscreenElement) return 1; },  
 101531: () => { return window.innerWidth; },  
 101557: () => { return window.innerHeight; }
};
